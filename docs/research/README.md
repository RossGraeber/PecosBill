...
unblocks build 2. Configuration selected: **2 × ~1500 W tangential bypass motors, parallel, one
per 120 V circuit (15 A + 20 A), lid provisioned for a third** (`P11.12`–`P11.13`). Open: `Q-V1`–`Q-V4`.
